  ...
  return (
    <div id='team' className='bg-black flex flex-col gap-10 items-center justify-center p-5 '>
      <div className='w-[60rem] text-white flex flex-col gap-4 items-center'>
        <h1 className='font-extrabold text-6xl text-white '><span className='text-red-600'>Who we are</span></h1>
      ...
      <div className='flex flex-col gap-2 items-center'>
        <div className='border border-white text-white h-[15rem] w-[12rem]'>
